...
define ('DISPLAY_ERROR_MESSAGES', false);				// Display error messages. Set to false to turn off errors (good for production websites)
...
define ('DEFAULT_Q', 80);								// Default image quality. Allows overrid in timthumb-config.php
